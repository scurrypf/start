<template>
    <div>
        ...
        <el-descriptions title="kokomi" direction="vertical" :column="4" border>
            ...
            <el-descriptions-item label="居住地" :span="2">America California San Francisco Oakland</el-descriptions-item>
            <el-descriptions-item label="备注">
                <el-tag size="small">家</el-tag>
            </el-descriptions-item>
            <el-descriptions-item label="联系地址">America California San Francisco Oakland</el-descriptions-item>
        </el-descriptions>
    </div>
</template>
